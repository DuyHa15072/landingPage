      ...
      <div class="Language flex items-center float-right right-[10px]">
        <ul class="group relative">
          ...
          <li
            ...
            "
           >
            <a href="/name" class="menu-item hover:border-white flex items-center">
              <svg
                width="30"
                height="30"
                viewBox="0 0 30 30"
            ...
            <nav>
              <ul class="ml-5 mt-[20px] px-[10px]">
                <li class="flex gap-[5px] items-center py-[10px]">
                  ...
                  Địa chỉ: Số 131 Thái Hà, Phường Trung Liệt, Quận Đống Đa,Thành
                  phố Hà Nội
                </li>
          ...
          <div class="contacts h-[747px] w-[732px] relative top-[-142px]">
            <div class="from_contact mx-[73px] my-[54px]">
              ...
              <form action="" class="form_contact">
                ...
                <input type="text" placeholder="Số điện thoại*" class="input_bg block py-3" />
                <input
                  type="submit"
                  value="Gửi"
                  class="
