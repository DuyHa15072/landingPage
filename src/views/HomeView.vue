              ...
              <nav>
                <ul class="ml-5 mt-[20px] px-[10px] nav_side3">
                  <li class="flex gap-[5px] items-center py-[10px]">
                    ...
                    <p> <strong class="">{{ $t("text_contact") }}</strong>: Phố 131 Thái Hà, Phường Trung Liệt, Quận
                      Đống
                      Đa,<br />Thành
                      phố Hà Nội</p>
                  </li>
            ...
            <div>
              ...
              <nav class="py-2">
                <ul class="flex gap-6 nav_footer">
                  <li>
                    <a href="https://www.facebook.com/oegvn"> <svg width="28" height="28" viewBox="0 0 28 28"
                  ...
                  <li>
                    <a href="https://www.youtube.com/user/wadesports"><svg width="28" height="28" viewBox="0 0 28 28"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
