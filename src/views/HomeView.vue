              ...
              <ul>
                <li class="group relative no-underline">
                  ...
                  <ul
                    ...
                    <li><RouterLink to="/ENG" class="menu-sub-item flex items-center mb-2" @click="setLocale('en')">
        ...
        <section class="p-[60px]">
          ...
          <div class="contact_lq flex flex-col gap-6 float-right mr-[200px]">
            ...
            <div>
              ...
              <p>
                Để được tư vấn và hỗ trợ miễn phí về việc tổ chức giải đấu, <br/>xin vui lòng liên hệ tới OEG ESPORTS qua Fanpage dưới đây.
              </p>
            </div>
            <div class="mb-[147px]">
