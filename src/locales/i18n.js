...
const i18n = new createI18n({
   ...
   messages:{
    en:{
      ...
      text_2 : 'Tournament System',
      text_national : 'PARTNERS BENEFITS',
      text_studentcup : ' STUDENT CUP BENEFITS',
      text_contact: 'CONTACT',
      text_about : 'ABOUT US',
      text_address : 'Address',
      text_submit: 'Submit',
      text_name: 'Name',
      text_company:'Unit/Company',
      text_position: 'Position',
      text_phone : 'Phone',
      text_jhonWith: 'JOIN WITH US',
    ...
    vn:{
      ...
      text_submit: 'Gửi',
      text_name: 'Họ Tên',
      text_company: "Đơn vị/Công ty",
      text_position: 'Chức Vụ',
      text_phone: 'Số Điện Thoại',
      text_jhonWith: 'KẾT NỐI VỚI CHÚNG TÔI',
